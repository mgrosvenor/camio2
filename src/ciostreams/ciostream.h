 ...
 */
int new_cioconn( char* uri , ciostr_req* properties, cioconn** cioconn_o );
 ...
 * - ECHECKERROR: The stream creation has failed. 
 */
int new_ciostr( char* uri ,  ciostr_req* properties, ciosel selector, u64 timeout_ns, ciostr** ciostream_o );
