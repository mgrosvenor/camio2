 ...
 *
 *  Created:    Jun 6, 2015
 *  File name:  device_opts_vec.c
 *  Description:
 *  Vector description for device options
 */

#include "device_params_vec.h"
#include "../../deps/chaste/data_structs/vector/vector_typed_define_template.h"


define_ch_vector(CAMIO_TRANSPORT_PARAMS_VEC,camio_device_param_t)

//Don't bother to define this yet.
define_ch_vector_compare(CAMIO_TRANSPORT_PARAMS_VEC,camio_device_param_t)
{
