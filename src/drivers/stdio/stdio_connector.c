...
extern camio_error_t fio_connect_peek(camio_connector_t* this);
#define stdio_connect_peek fio_connect_peek

extern camio_error_t fio_connect_ready(camio_connector_t* this);
#define stdio_connect_ready fio_connect_ready

extern camio_error_t fio_connect(camio_connector_t* this, camio_stream_t** stream_o );
 ...
 * Setup and teardown
 **************************************************************************************************************************/
extern camio_error_t fio_construct(camio_connector_t* this, void** params, ch_word params_size);
static camio_error_t stdio_construct(camio_connector_t* this, void** params, ch_word params_size)
{
...
extern void fio_destroy(camio_connector_t* this);
